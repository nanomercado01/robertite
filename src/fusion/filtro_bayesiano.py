...
def filtro_bayesiano(counter_encoder1,lidar_info, OBSTACLES_POS):    
    ...
    varianza_sens = distancia_prom * 0.01 #Segun el datasheet del rplidar A1 que usamos, el error para distancia mayores a 1.5m es del 1%, para menores es del 0.5%. el rango max es de 12m.
